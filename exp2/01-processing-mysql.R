...
if (!file.exists('case03/data/SourceMotLegend.csv')) {
  write_csv(legend, path = 'case03/data/SourceMotLegend.csv')
  legend <- read_csv('case03/data/SourceMotLegend.csv')
...
if (!file.exists('case03/data/SourceMotQuestWithCareless.csv')) write_csv(resp, 'case03/data/SourceMotQuestWithCareless.csv')
