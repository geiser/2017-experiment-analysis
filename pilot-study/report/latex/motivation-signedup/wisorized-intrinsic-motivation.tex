...
\usepackage{ctable}
\title{Summary of winsorized responses for the latent trait estimates by the RSM-based instrument for measuring intrinsic motivation in the pilot study for signed up students }
\begin{document}
...
\begin{longtable}{llllllllll}\caption{Summary of Winsorized responses for the latent trait estimates by the RSM-based instrument for measuring intrinsic motivation in the pilot study for signed up students} \tabularnewline
\hline\hline
