...
write_winsorized_in_latex(
  ...
  , in_title = paste("for intrinsic motivation score in the pilot study for signed up students")
)
...
lapply(list_dvs, function(dv) {
  ...
  write_param_statistics_analysis_in_latex(
    ...
    , in_title = paste0(" for ", dv, " score in the pilot study for signed up students")
  )
})
