...
write_csv(participants, path = "Participant02.csv") # write csv

## CaseStudy03 : 2017-Experiment02
##########################################################################
...
write_csv(participants, path = "Participant03.csv") # write csv

## CaseStudy04 : 2017-Experiment02
##########################################################################

write_csv(participants, path = "Participant04.csv") # write csv
