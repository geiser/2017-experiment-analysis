...
write_nonparam_statistics_analysis_in_latex(
  ...
  , in_title = paste("for Differences of Scores in the third study for students with effective participation")
)
...
write_param_statistics_analysis_in_latex(
  ...
  , in_title = paste("for the differences of scores in the third empirical study for students with effective participation")
)
