...
lapply(list_dvs, function(dv) {
  ...
  write_nonparam_statistics_analysis_in_latex(
    ...
    , in_title = paste0(" for the scores of ", dv
                        , " in the third study for signed up students")
  )
})
...
write_winsorized_in_latex(
  winsor_mod$diff_dat
  , filename = "report/latex/motivation-signedup/wisorized-scr-motivation.tex"
  , in_title = paste("for intrinsic motivation score in the third study for signed-up students")
)
...
lapply(list_dvs, function(dv) {
  ...
  write_param_statistics_analysis_in_latex(
    ...
    , in_title = paste0(" for ", dv, " score in the third study for signed-up students")
  )
})
