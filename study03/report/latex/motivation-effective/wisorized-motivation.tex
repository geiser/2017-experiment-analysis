...
\usepackage{ctable}
\title{Summary of winsorized responses for the latent trait estimates by the RSM-based instrument for measuring motivation in the third study for students with effective participation }
\begin{document}
...
\begin{longtable}{llllllllllllll}\caption{Summary of Winsorized responses for the latent trait estimates by the RSM-based instrument for measuring motivation in the third study for students with effective participation} \tabularnewline
\hline\hline
