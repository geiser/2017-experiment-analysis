...
\usepackage{ctable}
\title{Summary of winsorized responses for the latent trait estimates by the RSM-based instrument for measuring motivation in the third study for signed up students }
\begin{document}
...
\begin{longtable}{llllllllllllll}\caption{Summary of Winsorized responses for the latent trait estimates by the RSM-based instrument for measuring motivation in the third study for signed up students} \tabularnewline
\hline\hline
