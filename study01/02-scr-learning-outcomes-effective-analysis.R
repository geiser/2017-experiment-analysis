...
write_nonparam_statistics_analysis_in_latex(
  ...
  , in_title = paste("for Differences of Scores in the first study for students with effective participation")
)
...
write_param_statistics_analysis_in_latex(
  ...
  , in_title = paste("for the differences of scores in the first empirical study for students with effective participation")
)
