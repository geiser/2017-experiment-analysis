...
\usepackage{ctable}
\title{Summary of winsorized responses for the differences of scores in the first empirical study for signed-up students }
\date{}
\begin{document}
...
\begin{longtable}{llllllllll}\caption{Summary of Winsorized responses for the differences of scores in the first empirical study for signed-up students} \tabularnewline
\hline\hline
