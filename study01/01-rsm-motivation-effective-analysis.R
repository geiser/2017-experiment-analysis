...
extra_rmids <- list(
  "Interest/Enjoyment" = c(10230,10231)
  )
...
write_winsorized_in_latex(
  winsor_mod$diff_dat
  , filename = "report/latex/motivation-effective/wisorized-intrinsic-motivation.tex"
  , in_title = paste("for the latent trait estimates by",
                     "the RSM-based instrument for measuring"
                     ,"intrinsic motivation in the first study", "for students with effective participation")
)
