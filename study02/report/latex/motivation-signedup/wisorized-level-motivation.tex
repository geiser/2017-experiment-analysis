...
\usepackage{ctable}
\title{Summary of winsorized responses for the latent trait estimates by the RSM-based instrument for measuring level of motivation in the second study for signed up students }
\begin{document}
...
\begin{longtable}{lllllllll}\caption{Summary of Winsorized responses for the latent trait estimates by the RSM-based instrument for measuring level of motivation in the second study for signed up students} \tabularnewline
\hline\hline
