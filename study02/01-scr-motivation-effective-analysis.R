...
lapply(list_dvs, function(dv) {
  ...
  write_nonparam_statistics_analysis_in_latex(
    ...
    , filename = paste0("report/latex/motivation-effective/nonparametric-", sources[[dv]]$folder, "-scr-analysis.tex")
    , in_title = paste0(" for the scores of ", dv, " in the second study for students with effective participation")
  )
})
...
write_winsorized_in_latex(
  winsor_mod$diff_dat
  , filename = "report/latex/motivation-effective/wisorized-scr-level-of-motivation.tex"
  , in_title = paste("for level of motivation scores in the second study for students with effective participation")
)
...
lapply(list_dvs, function(dv) {
  ...
  write_param_statistics_analysis_in_latex(
    ...
    , in_title = paste0(" for ", dv, " score in the second study for students with effective participation")
  )
})
