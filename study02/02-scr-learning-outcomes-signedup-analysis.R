...
write_nonparam_statistics_analysis_in_latex(
  ...
  , in_title = paste("for Differences of Scores in the second study for signed-up students")
)
...
write_winsorized_in_latex(
  ...
  , in_title = paste("for the differences of scores in the second empirical study for signed-up students")
)
